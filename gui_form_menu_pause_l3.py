...
class FormPauseL3(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        super().__init__(name,master_surface,x,y,w,h,color_background,color_border,active)

          
        self.boton1 = Button(master=self,x=110,y=270,w=150,h=60,color_background=None,color_border=None,image_background="images\gui\set_gui_01\Pixel_Border\Elements\Element05s.png",on_click=self.on_click_boton1,on_click_param="form_game_L3",text="Reanudar",font="comicsansms",font_size=30,font_color="Brown")
