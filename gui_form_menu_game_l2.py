...
class FormGameLevel2(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton2 = Button(master=self,x=210,y=3,w=100,h=30,color_background=None,color_border=None,image_background="images/gui/set_gui_01/Comic_Border/Buttons/Button_M_02.png",on_click=self.on_click_boton1,on_click_param="form_pause_lvl2",text="Pause",font="comicsansms",font_size=20,font_color=C_BLACK)
        ...
        # --- GAME ELEMNTS --- 
        self.static_background = Background(x=0,y=0,width=self.ancho,height=self.alto,path="images/locations/backgrounds-desert/2/background.png")
        self.score_lvl = 0
        ...
        self.items_list.append(Items(120,325, 30,30,type=115))
        self.items_list.append(Items(550,325, 30,30,type=116))
        self.items_list.append(Items(735,115, 30,30,type=117))
        ...
        for row_num,row in enumerate(mapa):
            for column_num,column in enumerate(row):
                ...
                y = row_num * 30
                if column == "x":
                    self.plataform_list.append(Plataform(x,y,width=self.w_plataform,height=self.h_plataform,type=402))
                if column == "izq":
