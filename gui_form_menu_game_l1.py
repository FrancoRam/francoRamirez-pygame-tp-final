...
class FormGameLevel1(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        self.boton2 = Button(master=self,x=210,y=3,w=100,h=30,color_background=None,color_border=None,image_background="images/gui/set_gui_01/Comic_Border/Buttons/Button_M_02.png",on_click=self.on_click_boton1,on_click_param="form_pause_lvl1",text="Pause",font="comicsansms",font_size=20,font_color=C_BLACK)
        ...
        # --- GAME ELEMNTS --- 
        self.static_background = Background(x=0,y=0,width=self.ancho,height=self.alto,path="images/locations/backgrounds-desert/3/background.png")
        self.score_lvl = 0
