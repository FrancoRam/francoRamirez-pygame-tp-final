...
class FormGameLevel3(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        # --- GUI WIDGET --- 
        self.boton1 = Button(master=self,x=100,y=3,w=100,h=30,color_background=None,color_border=None,image_background="images/gui/set_gui_01/Comic_Border/Buttons/Button_M_02.png",on_click=self.on_click_boton1,on_click_param="form_menu_principal",text="Back",font="comicsansms",font_size=20,font_color=C_BLACK)
        self.boton2 = Button(master=self,x=210,y=3,w=100,h=30,color_background=None,color_border=None,image_background="images/gui/set_gui_01/Comic_Border/Buttons/Button_M_02.png",on_click=self.on_click_boton1,on_click_param="form_pause_lvl3",text="Pause",font="comicsansms",font_size=20,font_color=C_BLACK)
        self.boton_shoot = Button(master=self,x=320,y=3,w=100,h=30,color_background=None,color_border=None,image_background="images/gui/set_gui_01/Comic_Border/Buttons/Button_M_02.png",on_click=self.on_click_shoot,on_click_param="form_menu_B",text="Shoot",font="comicsansms",font_size=20,font_color=C_BLACK)
        ...
        self.enemy_list = []
        self.enemy_list.append (Enemy(x=450,y=400,speed_walk=7,speed_run=7,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.09,interval_time_jump=300))
        self.enemy_list.append (Enemy(x=900,y=400,speed_walk=7,speed_run=7,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.09,interval_time_jump=300))
        self.enemy_list.append (Enemy(x=600,y=400,speed_walk=7,speed_run=7,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.09,interval_time_jump=300))
        self.enemy_list.append (Enemy(x=300,y=400,speed_walk=9,speed_run=9,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.09,interval_time_jump=300))
        ...
        self.items_list.append(Items(70,325, 30,30,type=115))
        self.items_list.append(Items(550,325, 30,30,type=116))
        self.items_list.append(Items(800,115, 30,30,type=117))

        self.items_list.append(Items(40,325, 30,30,type=100))
        self.items_list.append(Items(600,325, 30,30,type=101))
        self.items_list.append(Items(750,115, 30,30,type=102))
        ...
        mapa = [                 
                ...
                ["izq"," "," "," "," "," "," "," "," "," "," "," "," "," ","der"],
                ["izq"," "," "," "," "," "," "," "," "," "," "," "," "," ","der"],
                ["izq"," "," ","x","x","x","x"," "," "," "," "," "," "," ","x","x","x","x","x","x","x","x","x","x","x","x","x","x","x","x","x","x"," ","x"," ","der"],
                ["izq"," "," "," "," "," "," "," "," "," "," "," "," "," ","der"],
                ["izq"," "," "," "," "," "," "," "," "," "," "," "," "," ","der"],
        ...
        for row_num,row in enumerate(mapa):
            for column_num,column in enumerate(row):
                ...
                y = row_num * 30
                if column == "x":
                    self.plataform_list.append(Plataform(x,y,width=self.w_plataform,height=self.h_plataform,type=403))
                if column == "izq":
    ...
    def init_lvl(self):
        ...
        self.enemy_list.append (Enemy(x=200,y=400,speed_walk=6,speed_run=5,gravity=14,jump_power=30,frame_rate_ms=150,move_rate_ms=50,jump_height=140,p_scale=0.08,interval_time_jump=300))
