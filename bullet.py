...
class Bullet():
    ...
    def __init__(self,owner,x_init,y_init,x_end,y_end,speed,frame_rate_ms,move_rate_ms,width=5,height=5) -> None:
        self.tiempo_transcurrido_move = 0
        self.tiempo_transcurrido_animation = 0
        # self.image = pygame.image.load(path).convert()
        # self.image = pygame.transform.scale(self.image,(width,height))
        self.image = Auxiliar.getSurfaceFromSeparateFiles("images/bullets_fire/FB00{0}.png",1,5,flip=False,scale=1)
